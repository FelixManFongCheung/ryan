    ...
    <div
      className={`work-names ${
        navMenu
          ...
          : "fixed z-[1] top-nav-offset hidden max-h-[calc(100dvh-theme(spacing.nav-offset))] cursor-pointer flex-col overflow-y-auto overscroll-contain scrollbar-none desktop:flex"
      }`}
    >
